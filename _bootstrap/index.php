...
if (!createObject('modNamespace',array(
    'name' => 'commerce_pickuptime',
    'path' => $componentPath.'/core/components/commerce_pickuptime/',
    'assets_path' => $componentPath.'/assets/components/commerce_pickuptime/',
),'name', false)) {
    echo "Error creating namespace commerce_pickuptime.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_pickuptime.core_path',
    'value' => $componentPath.'/core/components/commerce_pickuptime/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_pickuptime',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_pickuptime.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_pickuptime.assets_path',
    'value' => $componentPath.'/assets/components/commerce_pickuptime/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_pickuptime',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_pickuptime.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_pickuptime/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_pickuptime.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_pickuptime',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_pickuptime.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_pickuptime.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_pickuptime/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_pickuptime/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'modmore\\CommercePickupTime\\Modules\\', $modulePath);
